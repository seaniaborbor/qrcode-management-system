...
<body >
  ...
  <!-- navbar -->
 <!-- navbar -->
 <nav class="navbar navbar-expand-md  bg-primary pt-5 pb-4 ">
    <div class="container-xxl">
      ...
      <div class="collapse navbar-collapse justify-content-end align-center" id="main-nav">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link text-white" href="<?=base_url()?>#topics">About </a>
          </li>
 ...
 <section>
    ...
    <div class="col-md-4 offset-md-4" >
        <div class="card shadow-lg">
            ...
            <div class="card-body">
            <form action="<?=base_url('login')?>" method="post" class=" border-white">
        ...
        <button class=" px-5 btn btn-lg btn-primary text-white" type="submit">Sign in</button>
